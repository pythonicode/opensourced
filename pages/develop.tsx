import { Group, Image, Text, MediaQuery, Stack, Timeline, Title, Button, Divider, TextInput } from '@mantine/core';
                ...
                <Stack align="center" justify='center' spacing={64} p="xl" sx={(theme) => ({backgroundColor: theme.colors.indigo[5], minHeight: '100vh', maxWidth: '100vw'})}>
                    ...
                    <Timeline active={3} bulletSize={24} lineWidth={2} sx={{backgroundColor: '#fff', padding: '2rem', borderRadius: '1rem' }}>
                        <Timeline.Item bullet={<FaGithub />} title="Login with Github" pb="xl">
                            <Text size="sm" color="dimmed">Sign in with GitHub so we can gather some information about your account.</Text>
                        </Timeline.Item>
                        <Timeline.Item bullet={<FaWallet />} title="Connect to your Tron Wallet" pb="xl">
                            <Text size="sm" color="dimmed">Enter your Tron wallet address or connect with a TronLink wallet.</Text>
                        </Timeline.Item>
                        <Timeline.Item bullet={<FaCoins />} title="Start Collecting Rewards">
                            <Text size="sm" color="dimmed">Visit this page to collect rewards for any open source code that you've contributed.</Text>
                        </Timeline.Item>
                    </Timeline>
                </Stack>
                <Stack align="center" justify='center' p="xl" sx={{maxWidth: '100vw'}} py={100}>
